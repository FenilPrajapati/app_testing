odoo.define('freightbox.JOBDashboard', function (require) {
"use strict";
...
var QWeb = core.qweb;
let dashboardValues;
SampleServer.mockRegistry.add('job/job_dashboard', () => {
...
var SqListDashboardRenderer = ListRenderer.extend({
    events:_.extend({}, ListRenderer.prototype.events, {
        'click .o_job_dashboard_action': '_onDashboardActionClicked',
    }),
    /**
     * @override
     * @private
    ...
    _renderView: function () {
        ...
        return this._super.apply(this, arguments).then(function () {
            ...
            var tnt_dashboard = QWeb.render('freightbox.JOBDashboard', {
                values: values,
            });
...
view_registry.add('job_event_dashboard', TntListDashboardView);
return {
