odoo.define('freightbox.sq_dashboard', function (require) {
"use strict";
...
var QWeb = core.qweb;
let dashboardValues;
SampleServer.mockRegistry.add('shipment.quote/sq_dashboard', () => {
...
var SqListDashboardRenderer = ListRenderer.extend({
    events:_.extend({}, ListRenderer.prototype.events, {
        'click .o_sq_dashboard_action': '_onDashboardActionClicked',
    }),
    /**
     * @override
     * @private
    ...
    _renderView: function () {
        ...
        return this._super.apply(this, arguments).then(function () {
            ...
            var tnt_dashboard = QWeb.render('freightbox.SQDashboard', {
                values: values,
            });
...
var SqListDashboardView = ListView.extend({
...
view_registry.add('sq_event_dashboard', SqListDashboardView);
return {
